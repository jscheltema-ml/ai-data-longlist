"""Gain as a data source, over its MCP server."""

import uuid
from datetime import UTC, datetime

from agents.agents.gain_agent import gain_mcp_agent
...
async def gain_search(brief: Brief, search_volume: int, run_id: str | None = None) -> SourceBatch:
    ...
    response = await gain_mcp_agent.run(prompt)
